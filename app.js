...
function onClear() {
	...
	var base64OutputDiv = document.getElementById("base64OutputDiv");
	var base64Output = document.getElementById("base64Output");
	if (base64Output) base64Output.value = "";
	if (base64OutputDiv) base64OutputDiv.style.display = "none";
...
function copyBase64() {
	var base64Output = document.getElementById("base64Output");
	if (!base64Output || !base64Output.value) return;
	navigator.clipboard.writeText(base64Output.value).then(function () {
		var btn = document.getElementById("copyBase64Btn");
